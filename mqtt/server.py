...
MQTT_PORT = 1883
MQTT_TOPIC = "testtopic/temp/outTopic/666"

# Hostinger database settings
DB_HOST = "193.203.166.209"  # Replace with your database host
DB_USER = "u632723724_db_JoeyWalkup"       # Replace with your database username
DB_PASSWORD = "RasberrySwirl21"   # Replace with your database password
DB_NAME = "u632723724_JosephWalkup"
    ...
    try:
        ...
        if "Pot Value:" in payload:
            ...
            try:
                ...
                insert_query = "INSERT INTO sensor_data (voltage, time_received) VALUES (%s, %s)"
